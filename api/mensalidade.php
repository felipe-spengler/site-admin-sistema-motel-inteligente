...
<div class="container">
    <div class="card card-mensalidade">
        ...
        <div class="card-body">
            ...
            <h5 class="text-center mb-4 text-primary">Período de Referência: <span class="badge bg-primary"><?= htmlspecialchars($referente_mes_pt) ?></span></h5>
            
            <?php if ($meses_em_aberto > 1): ?>
                <div class="alert alert-warning text-center" role="alert">
                    <strong>Aviso:</strong> Este pagamento consolida **<?= $meses_em_aberto ?> mensalidade(s)** (incluindo as atrasadas).
                </div>
            <?php endif; ?>

            <?php if ($dias_atraso_exibicao > 0): ?>
                <div class="alert alert-danger text-center atraso-alert" role="alert">
                    <strong>ATENÇÃO:</strong> A mensalidade mais antiga está com **<?= $dias_atraso_exibicao ?> dias de atraso**.
                </div>
            <?php endif; ?>
            ...
            <ul class="list-group list-group-flush mb-4 border rounded">
                ...
                <li class="list-group-item d-flex justify-content-between align-items-center">
                    ...
                    <span class="<?= $valor_total_juros > 0 ? 'text-danger fw-bold' : '' ?>">R$ <?= number_format($valor_total_juros, 2, ',', '.') ?></span>
                </li>
            ...
            <div class="accordion mb-4" id="accordionDetalhe">
                <div class="accordion-item">
                    ...
                    <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#accordionDetalhe">
                            ...
                            <ul class="list-group list-group-flush">
                                ...
                                <li class="list-group-item small">
                                    ...
                                    <?php if ($detalhe['atraso_dias'] > 0): ?>
                                        (+ Multa: <?= number_format($detalhe['multa'], 2, ',', '.') ?> + Juros: <?= number_format($detalhe['juros'], 2, ',', '.') ?>)
                                        <span class="badge bg-danger float-end">Atrasado (<?= $detalhe['atraso_dias'] ?> dias)</span>
                                    <?php endif; ?>
                                    <span class="float-end fw-bold text-primary">R$ <?= number_format($detalhe['total'], 2, ',', '.') ?></span>
                                </li>
                                <?php endforeach; ?>
                            </ul>
                        </div>
            ...
            <a href="https://<?= htmlspecialchars($url_pix) ?>" class="btn btn-success btn-lg w-100 py-3" target="_self">
                PAGAR COM PIX
            </a>

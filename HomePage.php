...
<head>
    ...
    <style>
        ...
        #cabecalho {
            ...
            /* Redimensionar a imagem para cobrir todo o cabeçalho */
        ...
        .quarto {
            ...
            text-align: center;
            overflow: hidden;
            /* Para garantir que a imagem não transborde */
        }

        .quarto img {
            width: 100%;
            /* Largura da imagem igual à largura da div .quarto */
            height: 100%;
            /* Altura da imagem igual à altura da div .quarto */
        }
        ...
        #botaoVoltar {
            ...
            margin-right: 10px;
            float: left;
            /* Adiciona o botão à esquerda do rodapé */
        }
        ...
        .close {
            ...
            float: right;
            font-size: 40px;
            /* Aumentando o tamanho da fonte do botão de fechar */
            font-weight: bold;
        }
        ...
        .modal button {
            font-size: 28px;
            /* Aumentando o tamanho da fonte dos botões */
            padding: 26px;
...
<body>
    ...
    <div id="cabecalho"
        style="background-image: url('data:image/jpeg;base64,<?php echo base64_encode($imgCabecalho); ?>');"></div>
    ...
    <script>
        ...
        function enviaNumero(numeroQuarto) {
            // Buscar o tipo do quarto no array quartosDisponiveis
            var tipoQuarto = '';
            for (var i = 0; i < quartosDisponiveis.length; i++) {
                if (quartosDisponiveis[i][0] === numeroQuarto) {
                    tipoQuarto = quartosDisponiveis[i][1];
                    break;
                }
            }
            // Redirecionar para TelaExibicao.php com os dados do quarto
            window.location.href = 'TelaExibicao.php?dados=' + encodeURIComponent(numeroQuarto) + '&tipoQuarto=' + encodeURIComponent(tipoQuarto);
        }
    </script>
    <div id="rodape">

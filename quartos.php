...
<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.2/css/all.min.css" integrity="sha512-SNJ2I4f5H6eJk95a9y2eW4S4+3p1j6f1w5bE6bWzP+l5R6s5wz+L6Gg0F8+e68kQ8l9z6Kq6g1A0qg7sL4tQ==" crossorigin="anonymous" referrerpolicy="no-referrer" />

    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>

    <style>
        /* Cores customizadas baseadas no seu código original */
        .quarto-card.limpeza { background-color: #ffc107 !important; color: #000 !important; } 
        .quarto-card.manutencao { background-color: #6c757d !important; color: #fff !important; } 
        .quarto-card.livre { background-color: #198754 !important; color: #fff !important; } 
        .quarto-card.reservado { background-color: #0d6efd !important; color: #fff !important; } 
        .quarto-card.ocupado { background-color: #dc3545 !important; color: #fff !important; } 
        .quarto-card.pernoite { background-color: #e623c2 !important; color: #fff !important; } 
        ...
        .numero-quarto { font-size: 1.5rem; font-weight: bold; }
        .status-quarto { font-size: 0.85rem; opacity: 0.8; }
        
        /* Otimização visual para o menu de navegação - Garante que ele fique no final */
        .page-footer {
            width: 100%;
            margin-top: 30px; /* Espaço entre o conteúdo e o menu */
            padding: 15px 0;
        }
    </style>
</head>
<body class="bg-light">
    ...
    <div class="modal fade" id="menuSuspensoModal" tabindex="-1" aria-labelledby="menuSuspensoModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-sm modal-dialog-centered">
        <div class="modal-content">
          <div class="modal-header bg-dark text-white">
            <h5 class="modal-title" id="menuSuspensoModalLabel">Ações para o Quarto <span id="quartoModalNumero"></span></h5>
    ...
    <div class="modal fade" id="detalhesQuartoModal" tabindex="-1" aria-labelledby="detalhesQuartoModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-lg modal-dialog-scrollable">
        <div class="modal-content">
          ...
          <div class="modal-body" id="detalhesQuartoBody">
            <div class="text-center p-5"><div class="spinner-border text-primary" role="status"><span class="visually-hidden">Carregando...</span></div><p class="mt-2">Carregando...</p></div>
          </div>
          <div class="modal-footer">
        ...
        <?php  
            if ($cargo !== 'comum') {
                ...
                echo '<div class="text-center my-4">
                            <button onclick="window.location.href=\'login.php\'" class="btn btn-primary btn-lg shadow">
